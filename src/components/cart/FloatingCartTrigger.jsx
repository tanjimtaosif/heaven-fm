    ...
    <div className="animate-fade-up fixed right-4 bottom-5 z-40 sm:right-6 sm:bottom-6">
      <button
        ...
        className={cn(
          ...
          'border border-brass/50 bg-charcoal-deep/95 text-brass hover:border-brass hover:text-canvas',
          ...
          'focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brass focus-visible:ring-offset-2 focus-visible:ring-offset-canvas'
        )}
      ...
      >
        ...
        {/* Item count badge */}
        <span className="absolute -top-1 -right-1 flex h-5 min-w-5 items-center justify-center rounded-full bg-brass px-1 text-[11px] font-extrabold text-charcoal-deep shadow-xs ring-2 ring-charcoal-deep">
          {totalCount}
        </span>
      </button>
    </div>
